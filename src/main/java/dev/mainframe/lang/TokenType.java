...
public enum TokenType {
    IDENT, BAREWORD, STRING, INT, FLOAT, SIZE, VAR, FLAG_LONG, FLAG_SHORT,
    LET, IF, ELSE, FOR, IN, TRUE, FALSE, NOTHING, AND, OR, NOT,
    ...
    public boolean isKeyword() {
        return switch (this) {
            case LET, IF, ELSE, FOR, IN, TRUE, FALSE, NOTHING, AND, OR, NOT -> true;
            default -> false;
        };
    }
}
